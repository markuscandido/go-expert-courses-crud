...
const (
	...
	CategoryService_GetCategoryByCourseId_FullMethodName = "/pb.CategoryService/GetCategoryByCourseId"
)
...
type CategoryServiceClient interface {
	...
	GetCategoryByCourseId(ctx context.Context, in *GetCategoryByCourseIdRequest, opts ...grpc.CallOption) (*CategoryResponse, error)
}
...
func (c *categoryServiceClient) GetCategoryByCourseId(ctx context.Context, in *GetCategoryByCourseIdRequest, opts ...grpc.CallOption) (*CategoryResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(CategoryResponse)
	err := c.cc.Invoke(ctx, CategoryService_GetCategoryByCourseId_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CategoryServiceServer interface {
	...
	GetCategoryByCourseId(context.Context, *GetCategoryByCourseIdRequest) (*CategoryResponse, error)
...
func (UnimplementedCategoryServiceServer) GetCategoryByCourseId(context.Context, *GetCategoryByCourseIdRequest) (*CategoryResponse, error) {
...
func _CategoryService_GetCategoryByCourseId_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetCategoryByCourseIdRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CategoryService_GetCategoryByCourseId_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CategoryServiceServer).GetCategoryByCourseId(ctx, req.(*GetCategoryByCourseIdRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var CategoryService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "internal/application/adapter/grpc/v1/proto/course.proto",
}
